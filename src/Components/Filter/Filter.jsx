...
const Filter = () => {
    ...
    return (
        <div>
           <div className=' container mx-auto px-56 mt-10 '>
                <div className="p-5 rounded-lg bg-blue-400 drop-shadow-xl border border-gray-500"
                    style={{
                    ...
                    <div>
                        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                            <select className="px-4 py-3 w-full rounded-md bg-gray-50 border-transparent outline-0 focus:border-gray-500 focus:bg-white focus:ring-0 text-sm" style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '', }}>
                                <option value="jacket">Veg</option>
                                <option value="shirt">Non-Veg</option>
                                <option value="mobile">Daily</option>
                                <option value="jacket">Others</option>
                            </select>
                            <select className="px-4 py-3 w-full rounded-md bg-gray-50 border-transparent outline-0  focus:border-gray-500 focus:bg-white focus:ring-0 text-sm" style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '', }}>
